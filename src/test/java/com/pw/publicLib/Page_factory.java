...
//	Add SELL order extended Side tray
	...
	@FindBy(id = "total-order-value") // final order value
	...
	@FindBy(xpath = "//*[@id=\"draft_order_0\"]/p")  //draft orders title
	...
	@FindBy(xpath = "//*[@id=\"draft_order_1\"]//div[1]")   //close second draft order
	...
	@FindBy(xpath = "//*[@id=\"draft-body\"]/p") //draft page label
