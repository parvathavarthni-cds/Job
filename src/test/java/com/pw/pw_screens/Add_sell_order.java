...
public class Add_sell_order extends DataProvider{
	...
	public void available_exit_price_for_that_unit_should_not_display_more_than_decimals(int arg1) throws Throwable {
	    // Write code here that to validate the decimal places for exit price
		UIHandler_2 validate_decimal_places_exit_price = PageFactory.initElements(driver, UIHandler_2.class);
		driver = validate_decimal_places_exit_price.decimal_place_exit_price(driver);
	}
...
//	}
	...
	@And("^Final calculated value should be display as order value est with (\\d+) decimal places$")
